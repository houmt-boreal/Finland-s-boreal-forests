...
in_directory = r'E:\canopy\growing_stock2013\2013'
files = glob.glob(os.path.join(in_directory, '*.tif'))

# OUTPUT_FOLDER= r'E:\canopy\growing_stock2013\2013_two_values'
OUTPUT_FOLDER= r'E:\canopy\growing_stock2013\2013_nan'

for inRaster in files:

    outRaster = OUTPUT_FOLDER + '/nodata_9999' + inRaster[len(inRaster) - 7:len(inRaster) - 0]
